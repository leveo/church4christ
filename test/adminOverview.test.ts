...
const admin: SessionUser = { id: 1, email: 'a@x.com', displayName: 'A', role: 'admin', isAdmin: true, isEditor: false, memberTeamIds: [], leaderTeamIds: [], lang: 'en' };
const leader: SessionUser = { id: 2, email: 'l@x.com', displayName: 'L', role: 'member', isAdmin: false, isEditor: false, memberTeamIds: [1], leaderTeamIds: [1], lang: 'en' };
