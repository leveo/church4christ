...
const ALL_SCOPED_TABLES = [
  ...
  'identity_resolution_cases',
      'identity_source_attachment_receipts',
      'identity_source_attachment_commits',
      'identity_source_provisional_operations',
      'identity_source_provisional_receipts',
