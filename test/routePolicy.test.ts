...
describe('classifyRoute', () => {
  const cases: [string, RouteClass][] = [
    ...
    ['/admin/people/import/map/inspect', 'adminOnly'],
    ['/admin/people/import/map/profiles', 'adminOnly'],
    ['/admin/people/import/map/preview', 'adminOnly'],
    ['/admin/people/import/map/commit', 'adminOnly'],
    ['/admin/people/export', 'adminOnly'],
    ['/admin/people/export.csv', 'adminOnly'],
    ['/admin/people/export-notes', 'adminOnly'],
    ...
    ['/admin/activity-score', 'adminOnly'],
    ['/admin/activity-score/member/7', 'adminOnly'],
    ['/admin/onboarding', 'adminOnly'],
