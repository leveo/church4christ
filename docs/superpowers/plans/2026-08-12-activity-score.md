...
- Create `migrations/0016_activity_score.sql` and `migrations-supabase/0016_activity_score.sql`: portable configuration schema and defaults.
...
- Create: `migrations/0016_activity_score.sql`
- Create: `migrations-supabase/0016_activity_score.sql`
...
```bash
git add migrations/0016_activity_score.sql migrations-supabase/0016_activity_score.sql test/activityScoreSchema.test.ts test/pg/schemaParity.ts
