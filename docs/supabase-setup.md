...
Setup is capability-driven: selections among the 16 D1-compatible modules choose D1 unless
...
or Registration; the other 16 modules work on either database.
...
settings say they are on. New setup writes explicit selected settings for all 19 modules.
