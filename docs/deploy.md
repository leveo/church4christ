...
> **Which database?** The 13 D1-compatible modules need only Cloudflare when deployed.
...
Choose **Deploy**, then Website (8 modules), Website + Community (all 13 D1-compatible
modules), Full Church (all 16), or a custom feature list. Setup selects the database,
