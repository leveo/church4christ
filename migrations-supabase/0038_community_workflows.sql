...
REVOKE ALL ON fellowships FROM anon, authenticated;

ALTER TABLE fellowship_groups ENABLE ROW LEVEL SECURITY;
REVOKE ALL ON fellowship_groups FROM anon, authenticated;

ALTER TABLE fellowship_members ENABLE ROW LEVEL SECURITY;
REVOKE ALL ON fellowship_members FROM anon, authenticated;

ALTER TABLE workflow_templates ENABLE ROW LEVEL SECURITY;
REVOKE ALL ON workflow_templates FROM anon, authenticated;

ALTER TABLE workflow_runs ENABLE ROW LEVEL SECURITY;
REVOKE ALL ON workflow_runs FROM anon, authenticated;

ALTER TABLE workflow_tasks ENABLE ROW LEVEL SECURITY;
REVOKE ALL ON workflow_tasks FROM anon, authenticated;
